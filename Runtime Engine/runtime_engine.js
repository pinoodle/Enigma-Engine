...
function updateStats() {
  ...
  child.innerHTML = "<br>";
  for (var i = 0; i < statistics.length; i++) {
    child.innerHTML += "<div class='boxy' style='padding-left: 8px; padding-right: 8px;'><br>" + statistics[i].name.replace(/_/g, " ").toUpperCase() + ": " + eval("pl." + statistics[i].name) + statistics[i].symbol + "<br><br></div><br>";
  }
}
...
function showSettings() {
  ...
  if (ornt === "portrait") dom_mask.innerHTML += "<br>";
  dom_mask.innerHTML += "<div class='boxy' id='boxy_one'></div><br><div class='boxy' id='boxy_two'></div><br><div class='boxy' id='boxy_three'></div><br><div class='boxy' id='boxy_four'></div><br>"
  ...
  document.getElementById("boxy_two").innerHTML += "<br><div><u><strong>Font Size</strong></u></div><br><div class='slideContainer'><input type='range' step='0.1' min='0.8' max='1.8' value='" + fontSize + "' id='fontSizeSlider' class='slider'></div><br><div>(This option lets you change the size of text in the console)</div><br>";
  ...
  document.getElementById("boxy_four").innerHTML += "<div class='button' id='clearButton' style='margin: 0 auto; width: 13em;'>CLEAR CONSOLE</div><br><div>(This option lets you clear the console of all text)</div><br>";
